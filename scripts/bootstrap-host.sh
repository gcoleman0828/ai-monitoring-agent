...
log "Preparing AnythingLLM config directory"
mkdir -p anythingllm

if [ ! -f "anythingllm/.env" ] && [ -f "anythingllm/.env.example" ]; then
  cp anythingllm/.env.example anythingllm/.env
  echo "Created anythingllm/.env from anythingllm/.env.example"
fi
